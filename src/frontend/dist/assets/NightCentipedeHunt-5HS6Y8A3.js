...
import { V as Vector3, C as Canvas, A as ACESFilmicToneMapping, b as useThree, F as FogExp2, c as Color, u as useFrame } from "./react-three-fiber.esm-CHePJScM.js";
const MAP_COLORS = {
  forest: {
    ground: "#1e3a0a",
    skyDay: "#5a9fd4",
...
function StarField() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("points", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("pointsMaterial", { size: 0.8, color: "white", sizeAttenuation: true })
  ] });
}
function MoonMesh() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [-80, 120, -150], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("sphereGeometry", { args: [12, 16, 16] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("pointLight", { color: "#aabbff", intensity: 1.2, distance: 500 })
  ] });
}
function Ground({ map }) {
...
function GameScene({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    supercharged && /* @__PURE__ */ jsxRuntimeExports.jsx("ambientLight", { intensity: 0.5, color: "#ff1a00" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "directionalLight",
      {
        position: [-60, 30, 60],
