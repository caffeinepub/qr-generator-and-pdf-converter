import { r as reactExports, j as jsxRuntimeExports } from "./index-DmiYAAYm.js";
import { V as Vector3, C as Canvas, b as useThree, F as FogExp2, c as Color, u as useFrame } from "./react-three-fiber.esm-KJD4tUMm.js";
const MAP_COLORS = {
  forest: {
    ground: "#2d5016",
    skyDay: "#87ceeb",
...
function Ground({ map }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { rotation: [-Math.PI / 2, 0, 0], receiveShadow: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("planeGeometry", { args: [400, 400, 20, 20] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: MAP_COLORS[map].ground })
  ] });
}
const GRASS_DATA = (() => {
  const arr = [];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("group", { children: GRASS_DATA.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { position: [g.x, 0, g.z], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "mesh",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.05, 0.4, 0.3] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#3a7a1a" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0.15, 0.15, 0], rotation: [0, 0.8, 0.3], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.05, 0.3, 0.2] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#4a8a22" })
    ] })
  ] }, g.id)) });
}
const TREE_DATA = (() => {
...
function Trees() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("group", { children: TREE_DATA.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { position: [t.x, 0, t.z], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, t.h / 2, 0], castShadow: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("cylinderGeometry", { args: [0.22, 0.4, t.h, 7] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, t.h + t.h * 0.35, 0], castShadow: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("coneGeometry", { args: [t.h * 0.45, t.h * 0.8, 8] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#1a5c1a" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, t.h * 0.6, 0], castShadow: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("coneGeometry", { args: [t.h * 0.35, t.h * 0.6, 7] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#256025" })
    ] })
  ] }, t.id)) });
}
const ROCK_DATA = (() => {
...
function Rocks() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("group", { children: ROCK_DATA.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [r.x, r.s * 0.3, r.z], castShadow: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("dodecahedronGeometry", { args: [r.s, 0] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#777" })
  ] }, r.id)) });
}
const NPC_DATA = [
  { id: "npc-a", x: 25, z: 10 },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("group", { children: HOUSE_POSITIONS.map((pos) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "group",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, 3.6, 0], castShadow: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("coneGeometry", { args: [3.8, 2.2, 4] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "meshLambertMaterial",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, 0.75, 2.51], castShadow: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [1.2, 1.5, 0.05] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: canHide ? "#8b5a28" : "#1a0e00" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [1.4, 1.6, 2.51], children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.7, 0.7, 0.05] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "meshLambertMaterial",
            {
...
function NPC({
  ...
  useFrame((_, delta) => {
    ...
    if (groupRef.current)
      groupRef.current.position.y = Math.abs(Math.sin(s.walkPhase * 2)) * (fleeing ? 0.12 : 0.05);
  });
  const shirtColor = fleeing ? "#cc2200" : ["#885533", "#336688", "#558833", "#885566", "#334488", "#776633"][Math.floor(Math.abs(startX) % 6)];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { ref: groupRef, position: [startX, 0, startZ], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, 1.05, 0], castShadow: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.42, 0.6, 0.22] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: shirtColor })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, 1.58, 0], castShadow: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.28, 0.28, 0.26] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#cc9966" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, 1.75, 0], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.3, 0.08, 0.28] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#331100" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: legLRef, position: [-0.11, 0.55, 0], castShadow: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.16, 0.55, 0.18] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#223366" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: legRRef, position: [0.11, 0.55, 0], castShadow: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.16, 0.55, 0.18] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#223366" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: armLRef, position: [-0.28, 1.05, 0], castShadow: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.14, 0.48, 0.16] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: shirtColor })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: armRRef, position: [0.28, 1.05, 0], castShadow: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.14, 0.48, 0.16] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: shirtColor })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [-0.11, 0.08, 0.06], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.15, 0.1, 0.3] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#221100" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0.11, 0.08, 0.06], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.15, 0.1, 0.3] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#221100" })
...
function Centipede({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: headRef, position: positions.current[0], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("sphereGeometry", { args: [0.7, 12, 12] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: supercharged ? "#ff4400" : "#1a3300" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { position: positions.current[0], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0.3, 0.2, 0.55], children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0.25, -0.15, 0.65], rotation: [0.4, 0.3, 0], children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.08, 0.25, 0.08] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#0a2200" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [-0.25, -0.15, 0.65], rotation: [0.4, -0.3, 0], children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.08, 0.25, 0.08] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#0a2200" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0.18, 0.35, 0.5], rotation: [-0.6, 0.2, 0.1], children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("cylinderGeometry", { args: [0.02, 0.04, 0.6, 4] }),
    ...
    segKeys.map((k, i) => {
      const segSize = Math.max(0.25, 0.55 - i * 4e-3);
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "mesh",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("sphereGeometry", { args: [segSize, 8, 8] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "meshLambertMaterial",
                {
                  color: supercharged ? i % 2 === 0 ? "#cc3300" : "#991100" : isArmored ? "#2a5500" : i % 2 === 0 ? "#1a4400" : "#0d2200"
                }
              )
            ]
          }
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "mesh",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("cylinderGeometry", { args: [0.025, 0.015, segSize * 1.6, 4] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#0a1a00" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("pointLight", { ref: glowRef, color: "#ff4400", intensity: 0, distance: 20 })
  ] });
}
...
function PlayerMesh({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "group",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, 1.05, 0], castShadow: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.45, 0.65, 0.24] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#1155aa" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, 1.62, 0], castShadow: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.3, 0.3, 0.28] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#ffcc88" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, 1.79, 0], children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.32, 0.1, 0.3] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#221100" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0, 1.05, -0.18], children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.3, 0.5, 0.14] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#884422" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: legLRef, position: [-0.12, 0.5, 0], castShadow: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.17, 0.6, 0.19] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#334477" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: legRRef, position: [0.12, 0.5, 0], castShadow: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.17, 0.6, 0.19] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#334477" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: armLRef, position: [-0.3, 1.05, 0], castShadow: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.15, 0.52, 0.17] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#1155aa" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: armRRef, position: [0.3, 1.05, 0], castShadow: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.15, 0.52, 0.17] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#1155aa" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [-0.12, 0.09, 0.07], children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.16, 0.11, 0.32] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshLambertMaterial", { color: "#221100" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [0.12, 0.09, 0.07], children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("boxGeometry", { args: [0.16, 0.11, 0.32] }),
...
function GameScene({
  ...
  const superchargedRef = reactExports.useRef(false);
  ...
  const fogDensity = isDay ? 5e-3 : mode === "challenge" ? 0.03 : 0.016;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    supercharged && /* @__PURE__ */ jsxRuntimeExports.jsx("ambientLight", { intensity: 0.4, color: "#ff2200" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PlayerTorch,
      {
        playerPosRef,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: 24 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "#aa6666", marginTop: 4 }, children: "⚡ Every 1 minute: centipede SUPERCHARGES • Your speed increases permanently" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: "Click to lock mouse | WASD/joystick = move | Space/↑ = jump | Shift/🏃 = run | E = hide | V = cam | T = torch"
      }
    )
  ] });
}
    ...
    const onTouchMove = (e) => {
      if (e.touches.length >= 2) {
        for (let i = 0; i < e.touches.length; i++) {
          if (e.touches[i].identifier === lastTouch.id || e.touches.length >= 2) {
