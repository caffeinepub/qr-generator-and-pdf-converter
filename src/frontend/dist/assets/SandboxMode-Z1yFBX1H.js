import { r as reactExports, j as jsxRuntimeExports } from "./index-B10rTdIf.js";
import { C as Canvas, A as ACESFilmicToneMapping, V as Vector3, u as useFrame, b as useThree } from "./react-three-fiber.esm-CHePJScM.js";
import { S as Sky } from "./FlappyBird3D-Dgcx71xC.js";
const WEAPONS = [
  {
    name: "Pistol",
    levelReq: 2,
...
function NightStarsSandbox() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("points", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("pointsMaterial", { size: 0.7, color: "white", sizeAttenuation: true })
  ] });
}
function DayNightScene({
  ...
  return isDay ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sky, { sunPosition: [100, 30, 100], turbidity: 6, rayleigh: 2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("fog", { attach: "fog", args: ["#87CEEB", 100, 220] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ambientLight", { intensity: 0.7 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("hemisphereLight", { args: ["#87CEEB", "#3a6b3a", 0.4] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "directionalLight",
      {
        position: [30, 50, 30],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [100, 80, 100], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("sphereGeometry", { args: [6, 12, 12] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "meshStandardMaterial",
        {
          color: "#FFF5C0",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("fog", { attach: "fog", args: ["#0a0a1a", 40, 160] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ambientLight", { intensity: 0.25, color: "#2233aa" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "directionalLight",
      {
        position: [-50, 60, -50],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [-80, 120, -150], children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("pointLight", { color: "#aabbff", intensity: 1.5, distance: 400 })
    ] }),
