...
import { r as reactExports, j as jsxRuntimeExports, R as React } from "./index-CFZk4Y8R.js";
import { C as Canvas, P as PCFSoftShadowMap, A as ACESFilmicToneMapping, b as useThree, V as Vector3, F as FogExp2, G as Group, u as useFrame, c as Color, B as BackSide, O as Object3D } from "./react-three-fiber.esm-DsCHaUIa.js";
class GameAudio {
  constructor() {
...
function CityDowntownMap({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { children: [
    ...
    buildings.map((b, bi) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Building,
      {
        position: b.pos,
        size: b.size,
    ...
    Array.from({ length: 20 }, (_, i) => [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tree, { position: [15.5, 0, -280 + i * 43] }, `tr-${i}`),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tree, { position: [-15.5, 0, -280 + i * 43] }, `tl-${i}`)
    ]).flat(),
    Array.from({ length: 12 }, (_, i) => [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FireHydrant, { position: [12.2, 0, -240 + i * 62] }, `fhr-${i}`),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bench, { position: [14.8, 0, -200 + i * 70] }, `br-${i}`),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bench, { position: [-14.8, 0, -220 + i * 65] }, `bl-${i}`)
    ]).flat(),
...
function HighwayMap({ weather }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { children: [
    ...
    Array.from({ length: 13 }, (_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { position: [20, 0, -600 + i * 100], children: [
    ...
    Array.from({ length: 25 }, (_, i) => [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tree, { position: [30, 0, -580 + i * 46] }, `tr-${i}`),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tree, { position: [-30, 0, -580 + i * 46] }, `tl-${i}`)
    ]).flat()
  ] });
}
function MountainMap({ weather }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { children: [
    ...
    [
      ...
      [0, 55, -180],
      [0, 55, 180]
    ].map(([x, y, z], si) => /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [x, y, z], children: [
...
function DesertMap({ weather }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("group", { children: [
    ...
    Array.from({ length: 16 }, (_, i) => [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position: [30 + i % 4 * 18, -4, -400 + i * 55], children: [
...
function GameScene({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("ambientLight", { intensity: isNight ? 0.06 : cfg.ambientIntensity * 0.9 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "directionalLight",
      {
        position: cfg.sunPos,
    ...
    gs.weather === "fog" && /* @__PURE__ */ jsxRuntimeExports.jsx("ambientLight", { intensity: 0.6, color: "#c8d8e8" }),
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                ...
                children: [
                  ...
                  [0, 45, 90, 135, 180, 225, 270, 315].map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "rect",
                    {
                      x: "66",
                      y: "4",
